  ...
  fileprivate static let grammar: [LanguageTopic] = [
    ...
    topic(
      ...
      body: text(
        ...
        "12.50 EUR, EUR 12.50, €5, and 5€ are money. $ is USD unless Format ▸ Dollar Means or the sheet's right-click menu picks another dollar currency. USD 1.5, 5 dollars, dollars 5, and 11.5 million are the same kinds of amount. ¥ is yen. A price can be per unit: $0.15/kWh * 45 kWh is $6.75. €40 + $10 adds the dollars in euros. 100 USD in INR converts with the European Central Bank daily rates, or a rate you declare: 1 USD = 83 INR. Automatic downloads can be turned off."
      ),
      examples: [
