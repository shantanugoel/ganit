...
- [ ] Embed `NSTextView` with correct IME, bidi, selection, responder-chain and undo behavior.
...
- [ ] Implement source/metadata files, atomic replace and checksums.
...
- [ ] Implement distinct date/time/instant/calendar-period/duration values.
...
- [ ] Run the complete section 9 and manual matrix.
